...
import org.ethereumkeyj.core.util.BIUtil;
...
public class ECKey implements Serializable
{
  ...
  static
  {
    ...
    provider = EthSecurityProvider.getInstance();
  }
  ...
  {
    this(
            EthSecurityProvider.getInstance(),
...
//      }
      ...
      if(!BIUtil.isLessThan(s, SECP256K1N))
      {
        return false;
      }
